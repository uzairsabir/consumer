...
import com.thetechsolutions.whodouconsumer.AppHelpers.WebService.Parser;
...
public class SignUpModel {
    ...
    protected boolean signUp(String email, String firstName, String lastName, String zipCode) {
