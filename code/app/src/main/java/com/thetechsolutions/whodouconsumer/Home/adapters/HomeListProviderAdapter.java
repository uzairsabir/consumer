...
public class HomeListProviderAdapter extends ItemViewHolder<ProviderDT> {
    ...
    public HomeListProviderAdapter(View view) {
        super(view);
    }

    static int pos, positioninfo;

    public static Class<HomeListProviderAdapter> newInstance(Activity _activity, int _pos) {
        activity = _activity;
        pos = _pos;
        return HomeListProviderAdapter.class;
    }
